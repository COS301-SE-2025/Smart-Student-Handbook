  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (snapshot.exists()) {
        ...
        const incomingIds: string[] = data.incomingRequests || []
        const sentIds: string[] = data.sentRequests || []
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 w-full min-h-screen">
        ...
        <Card className="h-fit">
          <CardHeader className="pb-3 space-y-3">
            ...
            <Button className="w-full justify-start mt-3 bg-blue-500 hover:bg-blue-700 text-white" size="sm">
