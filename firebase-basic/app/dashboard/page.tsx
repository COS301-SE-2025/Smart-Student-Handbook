              ...
              <div className="col-span-1 bg-card p-4 rounded-lg shadow">
                ...
                <div className="space-y-4">
                  {notebooks.map((notebook) => (
                    <Link href="#" key={`${notebook.title}-${notebook.timestamp}`}>
                      <div className="border-b py-2 hover:bg-muted/50 transition-colors">
                        <div className="flex flex-col w-full">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            <span className={`px-2 py-1 rounded ${notebook.tagType === "important" ? "bg-red-100 text-red-800" : "bg-gray-100 text-gray-800"}`}>
                              {notebook.tag}
                            </span>
                ...
                <div className="bg-card p-4 rounded-lg shadow">
                  ...
                  <div className="flex items-end gap-2 h-20">
                    {studyHours.map((hours, index) => (
                      <div key={index} className="bg-muted w-8 rounded" style={{ height: `${hours * 10}px` }}></div>
                    ))}
                  </div>
                </div>
              </div>
