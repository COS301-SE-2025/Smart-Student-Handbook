...
// UI component mocks with proper typing
...
jest.mock("@/components/ui/input", () => ({
  Input: React.forwardRef<HTMLInputElement, InputProps>((props, ref) => (
    <input ref={ref} {...props} />
  )),
}));
...
jest.mock("next/image", () => ({
  __esModule: true,
  default: ({ fill, priority, ...props }: ImageProps) => (
    <img 
      {...props} 
...
describe('LoginForm() LoginForm method', () => {
  ...
  describe('Happy paths', () => {
    ...
    test('applies custom className from parent to root div', () => {
      render(<LoginForm className="custom-class" data-testid="login-form-container" />);
