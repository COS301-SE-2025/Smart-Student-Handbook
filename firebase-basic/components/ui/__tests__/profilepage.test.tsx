...
function simulateSaveWhenChanged() {
  const saveUserSettings = require("/Users/mpumenjamela/Smart-Student-Handbook-1/firebase-basic/utils/SaveUserSettings").saveUserSettings;
...
describe('ProfilePage() ProfilePage method', () => {
  ...
  describe('Happy Paths', () => {
    ...
    test('shows info toast when saving with no changes', async () => {
      ...
      // Since button is disabled, we can't click it - but we can test the logic by calling handleSave directly
      // This is a workaround for testing the toast.info call
      const { toast } = require('sonner');
      
      // Mock the condition that would trigger the toast
