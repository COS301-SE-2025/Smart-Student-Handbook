...
//   return (
//     <header className="fixed top-0 left-0 right-0 z-50 h-14 border-b border-border">
//       <div className="flex h-full items-center justify-between px-4">
//         {/* Left: Sidebar trigger and page title */}
//         <div className="flex items-center gap-3">
//           <SidebarTrigger className="h-8 w-8 text-black" />
//           <div className="flex items-center gap-2">
//             <div className="text-muted-foreground">{pageInfo.icon}</div>
//             <h1 className="font-semibold text-foreground text-black">{pageInfo.title}</h1>
//           </div>
//         </div>
